================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : OpenGL Project Overview
===============================================================================

The application wizard has created this OpenGL application for
...
OpenGLDlg.h, OpenGLDlg.cpp - the dialog
    These files contain your COpenGLDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in OpenGL.rc, which can be edited in Microsoft Visual C++.
